...
/**
 * Renders currency drop down information.
 *
 * TRenders the currency selector drop down to use as a remote include
 */
function includeCurrencySelector() {
    app.getView().render('components/header/currencyselector');
}
 ...
 * 
 */
function agileOneSnippet() {
	app.getView().render('webtag/basicsnippet');
}
/*
...
/** Renders the currency selector drop down to use as a remote include.
 * @see module:controllers/Home~includeCurrencySelector */
exports.IncludeCurrencySelector = guard.ensure(['include'],includeCurrencySelector);
...
/** Renders the agile one  code snippet to use as a remote include.
 * @see module:controllers/Home~agileOneSnippet */
exports.AgileOneSnippet = guard.ensure(['include'],agileOneSnippet);
